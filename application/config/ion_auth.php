 ...
 */
$config['site_title']                 = "Miss Call";       // Site Title, example.com
$config['admin_email']                = "test@portal.misscall.co.in"; // Admin Email, admin@example.com
$config['default_group']              = 'user';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['identity']                   = 'username';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes "username","email"
...
$config['email_config'] = array(
	'mailtype' => 'html',
        'protocol' => 'smtp',
        'smtp_host' => 'mail.portal.misscall.co.in',
        'smtp_user' => 'test@portal.misscall.co.in', // actual values different
        'smtp_pass' => 'jack1234',
        'smtp_port' => '25'
);
