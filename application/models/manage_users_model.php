 ...
 *
 */
Class Manage_users_model extends APP_Model {
    ...
    /* 	
      # Function          :	manage_other_users_live_search
    ...
    function manage_other_users_live_search($searchdata, $keyword, $sort_column, $sort_order, $limit, $start) {
        ...
        if ($keyword) {
            $this->db->where("(users.first_name LIKE '%$keyword%' OR  users.first_name LIKE '%$keyword%')");
        }
    ...
    /* 	
      # Function          :	manage_other_users_live_search_count
      # Purpose           :	count for the keyword
      # params            :	keyword
      # Return            :   number
     */

    function manage_other_users_live_search_count($searchdata, $keyword) {
