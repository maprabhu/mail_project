...
<html>
  <head>
    ...
    <![endif]-->
     <script src="<?php echo base_url('assets/plugins/datatables/jquery.min.js'); ?>"></script>
    <script src="<?php echo base_url('assets/datatable/jquery.validate.min.js');?>"></script> 
    <!-- Bootstrap 3.3.2 JS -->
  ...
  <body class="skin-green">
    <div class="wrapper">
      <?php
        $count_dom_name = strlen("MailServer");
        $dom_space = "";
        if($count_dom_name > 17){
          $dom_space = "..";
        }

      ?>  
      <header class="main-header">
        <a href="<?php echo base_url();?>" class="logo"><b><?php echo substr("MailServer",0,18).$dom_space;?></b></a>
