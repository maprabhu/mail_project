      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            -->
            <li class="<?php echo (($this->uri->segment(1) === 'manage_users') || ($this->uri->segment(2) === 'manage_subscription')) ? 'active' : '' ;?>">
              <a href="<?php echo base_url('manage_users/manage_other_users');?>">
                <i class="fa fa-user"></i> <span>Users</span> 
              </a>
            </li>
